...
export default {
  ...
  setup(props) {
    ...
    const userExisted = computed(() => props.user);
    
    watch([userExisted], () => setUserExisted(userExisted.value));

    function setUserExisted(e) {
      if (e) {
        userId.value = e.id;
        user.username = e.username;
        user.email = e.email;
        user.fullname = e.fullname;
        user.enabled = e.enabled;
        user.createdBy = e.createdBy;
